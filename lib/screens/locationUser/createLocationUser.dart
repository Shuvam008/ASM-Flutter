...
class CreateLocationUser extends StatefulWidget {
  const CreateLocationUser({super.key});

  @override
  State<CreateLocationUser> createState() => _CreateLocationUserState();
}

class _CreateLocationUserState extends State<CreateLocationUser> {
    ...
    return Scaffold(
        ...
        body: BlocBuilder<UserBloc, UserState>(
          builder: (context, state) {
            if (state is LocationUsersFetched) {
              return PageView(
                        ...
                        BlocListener<UserBloc, UserState>(
                          listener: (context, state) {
                            if (state is UserAddedError) {
                              ...
                              print("User Save faield");
                              context
                                  .read<UserBloc>()
                                  .add(LocationUsersFetch());
                              _pageController.previousPage(
