...
class UpdateLocationUser extends StatefulWidget {
  final User user;
  const UpdateLocationUser({super.key, required this.user});

  @override
  State<UpdateLocationUser> createState() => _UpdateLocationUserState();
}

class _UpdateLocationUserState extends State<UpdateLocationUser> {
