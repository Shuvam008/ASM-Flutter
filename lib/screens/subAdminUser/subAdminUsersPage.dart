...
class SubAdminUsersPage extends StatefulWidget {
  const SubAdminUsersPage({super.key});

  @override
  State<SubAdminUsersPage> createState() => _SubAdminUsersPageState();
}

class _SubAdminUsersPageState extends State<SubAdminUsersPage> {
  @override
  void initState() {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/createSubAdmin');
                },
                child: Container(
                  padding: kEdgeInsetsAllNormal,
                  decoration: BoxDecoration(
            ...
            child: RefreshIndicator(
              ...
              child: BlocBuilder<UserBloc, UserState>(
                builder: (context, state) {
                  ...
                  } else if (state is SubAdminUsersFetched) {
                            ...
                            ? GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => ViewSubAdminPage(
