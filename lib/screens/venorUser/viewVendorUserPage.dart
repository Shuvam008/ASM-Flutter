...
class ViewVendorPage extends StatefulWidget {
  final User user;
  const ViewVendorPage({super.key, required this.user});

  @override
  State<ViewVendorPage> createState() => _ViewVendorPageState();
}
...
class _ViewVendorPageState extends State<ViewVendorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: "View Vendor"),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => UpdateVendorUser(
                                    user: widget.user,
                                  )),
                        );
                      },
